...
<head>
    ...
    <link href="css/mdb.css" rel="stylesheet" media="screen">
...
<body style="height:100%;background-color:silver;">
    ...
    <div class="signin-form container-fluid">
        ...
        <div class="row mb-5" style="margin:60px;">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    <form class="md-form form-signin " method="post" id="login-form" style="margin-bottom:95px;width:300px;border:2px solid green;border-style: double;">
                    ...
                    <div class="md-form form-group ml-4">
                        ...
                        <i class="fas fa-envelope prefix blue-text mt-2"></i>
                        <input type="email" class="form-control " placeholder="email" name="user_email" id="user_email" style="width:200px;">
                        <span id="check-e"></span>
                    </div>

                    <div class="md-form form-group ml-4">
                       
                         <i class="fas fa-lock prefix blue-text mt-2"></i>
                        <input type="password" class="form-control" placeholder="password" name="password" id="password" style="width:200px;">
                    </div>
